...
class Mdl_Clients extends Response_Model {
    ...
    public function default_select()
    {
       ...
       $this->db->select('SQL_CALC_FOUND_ROWS fi_client_custom.*,fi_user_clients.*,fi_clients.*', FALSE);
        //$sqlE=$this->filter_select("SELECT client_id FROM fi_user_clients WHERE user_id =".$_SESSION['user_id']."");
       // echo $sqlE;
    ...
    public function default_join()
    {
        ...
        $this->db->join('fi_user_clients', 'fi_user_clients.client_id=fi_clients.client_id','left');
    }
    ...
    public function validation_rules()
    {
        return array(
            ...
            'client_register_number'      => array(
                'field' => 'client_register_number',
                'label' => lang('client_register_number')
            ),
            'client_active'    => array(
                'field' => 'client_active'
            ),
