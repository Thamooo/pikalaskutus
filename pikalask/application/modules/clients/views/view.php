...
<div class="headerbar">
	...
	<div class="pull-right">
		<a href="#" class="btn btn-default client-create-quote" data-client-name="<?php echo $client->client_name; ?>"><i class="icon-plus-sign"></i> <?php echo lang('create_quote'); ?></a>
		<a href="#" class="btn btn-default client-create-invoice" data-client-name="<?php echo $client->client_name; ?>"><i class="icon-plus"></i> <?php echo lang('create_invoice'); ?></a>
		<a href="<?php echo site_url('clients/form/' . $client->client_id); ?>" class="btn btn-default"><i class="icon-pencil"></i> <?php echo lang('edit'); ?></a>
			...
			<div class="profile">
				...
				<div class="primaryInfo row">
					...
					<div class="pull-left">
						...
						<br>
						<span>
							<?php echo ($client->client_register_number) ? $client->client_register_number . '<br>' : ''; ?>
