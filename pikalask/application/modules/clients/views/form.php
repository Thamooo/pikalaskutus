        ...
        <fieldset>
            ...
            <div class="control-group">
             ...
             <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="client_register_number" id="client_register_number" value="<?php echo $this->mdl_clients->form_value('client_register_number'); ?>"><br/>
                    <a href="http://www.ytj.fi/yrityshaku.aspx?path=1547;1631;1678&kielikoodi=1" target="_blanc"><?php echo lang('client_lookup_register_number'); ?></a>
                </div>
            </div>
