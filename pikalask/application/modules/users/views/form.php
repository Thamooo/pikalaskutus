        ...
        <div id="userInfo">
            ...
            <fieldset>
                ...
                <div class="control-group">
                  ...
                  <div class="control-group">
                    <label class="control-label"><?php echo lang('client_register_number'); ?>: </label>
                    <div class="controls">
                        <input type="text" name="user_register_number" id="user_register_number" value="<?php echo $this->mdl_users->form_value('user_register_number'); ?>">
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="email" name="user_email" id="user_email" value="<?php echo $this->mdl_users->form_value('user_email'); ?>">
                    </div>
                </div>

                <div class="control-group">
                    <label class="control-label"><?php echo lang('bank_account_number'); ?>: </label>
                    <div class="controls">
                        <input type="text" name="user_iban" id="user_iban" value="<?php echo $this->mdl_users->form_value('user_iban'); ?>">
                    </div>
                </div>

                <div class="control-group">
                    <label class="control-label"><?php echo lang('bank_bic_number'); ?>: </label>
                    <div class="controls">
                        <input type="text" name="user_bic" id="user_bic" value="<?php echo $this->mdl_users->form_value('user_bic'); ?>">
                    </div>
                </div>
