...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
	...
	<head>
		...
		<meta name="author" content="Pikalaskutus">
	...
	<body>
		...
		<nav class="navbar navbar-inverse">
			...
			<div class="navbar-inner">
				...
				<div class="container-fluid">
					<div style="margin-left:-20px;" class="navLogo"><img alt="" src="<?php echo base_url(); ?>assets/default/img/icons/logo.png" height="24" width="24" title="Nopsatlaskut" /></div>
		...
		<div class="sidebar">
			...
			<ul>
				<li><a href="<?php echo site_url('guest'); ?>"><img alt="" src="<?php echo base_url(); ?>assets/default/img/icons/hallinta.png" height="24" width="24" title="<?php echo lang('dashboard'); ?>" /></a></li>
				<li><a href="<?php echo site_url('guest/quotes/index'); ?>"><img alt="" src="<?php echo base_url(); ?>assets/default/img/icons/asiakkaat.png" height="24" width="24" title="<?php echo lang('clients'); ?>" /></a></li>
				<li><a href="<?php echo site_url('guest/invoices/index'); ?>"><img alt="" src="<?php echo base_url(); ?>assets/default/img/icons/laskut.png" height="24" width="24" title="<?php echo lang('invoices'); ?>" /></a></li>
				<li><a href="<?php echo site_url('guest/payments/index'); ?>"><img alt="" src="<?php echo base_url(); ?>assets/default/img/icons/maksut.png" height="24" width="24" title="<?php echo lang('quotes'); ?>" /></a></li>
			</ul>
